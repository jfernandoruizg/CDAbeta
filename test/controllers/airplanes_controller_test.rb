...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { fadquisicion: @airplane.fadquisicion, matricula: @airplane.matricula, modelo: @airplane.modelo, nasientos: @airplane.nasientos, tipo: @airplane.tipo } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { fadquisicion: @airplane.fadquisicion, matricula: @airplane.matricula, modelo: @airplane.modelo, nasientos: @airplane.nasientos, tipo: @airplane.tipo } }
