...
class PilotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post pilots_url, params: { pilot: { fcontratacion: @pilot.fcontratacion, ncedula: @pilot.ncedula, nlicencia: @pilot.nlicencia, nombrec: @pilot.nombrec } }
    end
  ...
  test "should update pilot" do
    patch pilot_url(@pilot), params: { pilot: { fcontratacion: @pilot.fcontratacion, ncedula: @pilot.ncedula, nlicencia: @pilot.nlicencia, nombrec: @pilot.nombrec } }
